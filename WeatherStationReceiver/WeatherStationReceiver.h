...
#define GREEN_TESTLED_IS_ON()       ((PORTD & (1<<PORTD4)) == 0)
#define GREEN_TESTLED_IS_OFF()      ((PORTD & (1<<PORTD4)) != 0)
#define GREEN_TESTLED_ON()          ((PORTD &= ~(1<<PORTD4)))
#define GREEN_TESTLED_OFF()         ((PORTD |=  (1<<PORTD4)))
