...
#define WSR_PERIOD_FILTER_MIN        ( 220/WSR_TIMER_PERIOD_US)   //min 300uS  allowed through filter
#define WSR_PERIOD_FILTER_MAX        (1600/WSR_TIMER_PERIOD_US)   //max 1800uS allowed through filter
//detection of a 'SHORT', nominal 367uS
#define WSR_SHORT_PERIOD_MIN         WSR_PERIOD_FILTER_MIN        //
#define WSR_SHORT_PERIOD_MAX         ( 420/WSR_TIMER_PERIOD_US)   //max 600uS for a "SHORT"
