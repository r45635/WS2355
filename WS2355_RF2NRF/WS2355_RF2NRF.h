...
#define WSR_PERIOD_FILTER_MIN        ( 200/WSR_TIMER_PERIOD_US)   //210 min 300uS  allowed through filter
#define WSR_PERIOD_FILTER_MAX        (1650/WSR_TIMER_PERIOD_US)   //1650 max 1800uS allowed through filter
//detection of a 'SHORT', nominal 367uS
#define WSR_SHORT_PERIOD_MIN         WSR_PERIOD_FILTER_MIN        //
#define WSR_SHORT_PERIOD_MAX         ( 450/WSR_TIMER_PERIOD_US)   //440 max 600uS for a "SHORT"
//detection of a 'LONG', nominal 1464uS
#define WSR_LONG_PERIOD_MIN          (1100/WSR_TIMER_PERIOD_US)   //1180 min 1200uS for a "LONG"
